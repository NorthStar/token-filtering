"""
Plot evaluation results from eval-multimedqa.py

Creates a faceted bar plot showing the proportion of YES responses for each
evaluation criterion, grouped by mask type and faceted by dataset.
"""
...
parser.add_argument('--input_dir', type=str, default='results/multimedqa-graded')
args = parser.parse_args()

# Evaluation criteria from eval-multimedqa.py
CRITERIA = [
    "correctness",
    "relevance-easy",
    "coherence"
...
print("\nCalculating proportions across all datasets...")
all_results = []
for mask in df['mask'].unique():
...
p1.save('plots/multimedqa-evaluation.png', dpi=300, width=3.375, height=2.5)
p1.save('plots/multimedqa-evaluation.svg', dpi=300, width=3.375, height=2.5)
p1.save('plots/multimedqa-evaluation.pdf', dpi=300, width=3.375, height=2.5)

print(f"\nPlot 1 saved as 'plots/multimedqa-evaluation.png', 'plots/multimedqa-evaluation.svg', and 'plots/multimedqa-evaluation.pdf'")
print(p1)
...
p2.save('plots/multimedqa-evaluation-relative.png', dpi=300, width=7, height=2.625)
p2.save('plots/multimedqa-evaluation-relative.svg', dpi=300, width=7, height=2.625)
p2.save('plots/multimedqa-evaluation-relative.pdf', dpi=300, width=7, height=2.625)

print(f"\nPlot 2 saved as 'plots/multimedqa-evaluation-relative.png', 'plots/multimedqa-evaluation-relative.svg', and 'plots/multimedqa-evaluation-relative.pdf'")
print(p2)
