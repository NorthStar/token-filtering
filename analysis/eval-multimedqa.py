"""
Evaluate chat model generations on medical QA using Claude API with multiple evaluation criteria
"""
...
parser.add_argument("--data_path", type=str, default="multimedqa-outputs", help="path to input jsonl files")
parser.add_argument("--model_string", type=str, default="claude-sonnet-4-20250514", help="Claude model to use")
args = parser.parse_args()

# Define evaluation prompts (placeholders - user will fill in)
EVALUATION_PROMPTS = {
    ...
    "consensus": "is the provided response consistent with the consensus of the scientific and clinical community?",
    "comprehension": "does the provided response contain evidence of correct reading comprehension?",
    "retrieval": "does the provided response contain evidence of correct retrieval of knowledge?",
    "relevance-easy": "does the provided response attempt to be at all relevant to the question asked?",
...
async def main():
    ...
    output_dir = os.path.join('results', 'multimedqa-graded')
